 ...
 * */
#define USBPD_BSP_USART			  USART2//1

/**
 * @brief Clock Enable Macro
 * */
#define USBPD_BSP_USARTCLK_ENABLE	        __HAL_RCC_USART2_CLK_ENABLE//__HAL_RCC_USART1_CLK_ENABLE
...
#define USART_TX_PIN			        GPIO_PIN_2//9
#define USART_RX_PORT			        GPIOA
#define USART_RX_PIN			        GPIO_PIN_3//10
#define USART_PIN_GPIOAF		        GPIO_AF1_USART2//1
#define USART_IRQ			        USART2_IRQn//USART1_IRQn
...
USBPD_BSP_GPIOPins_TypeDef USBPD_BSP_LEDs[USBPD_BSP_LEDn] =
    {
      ...
      USBPD_BSP_PIN(GPIOC,10),          /* LED_RGB Blue  1 */
      USBPD_BSP_PIN(GPIOC,11),          /* LED_RGB Green 2 */
      USBPD_BSP_PIN(GPIOC,12)           /* LED_RGB Red   3 */
